						...
						<div class="space-y-5 xl:col-span-3">
							<div class="space-y-6">
								...
								<div class="prose max-w-none text-gray-500 dark:text-gray-400">
									Release of Tailwind Nextjs Starter Blog template v2.0, refactored with Nextjs App
									directory and React Server Components setup.Discover the new features and how to
									migrate from V1.
								</div>
							</div>
						...
						<div class="space-y-5 xl:col-span-3">
							...
							<div class="text-base font-medium leading-6">
								<a
									...
									href="/blog/new-features-in-v1">Read more →</a
								>
							</div>
						</div>
					</div>
							...
							<div class="space-y-6">
								<div>
									...
									<div class="flex flex-wrap">
										<a
											class="mr-3 text-sm font-medium uppercase text-primary-500 hover:text-primary-600 dark:hover:text-primary-400"
											href="/tags/multi-author">multi-author</a
										><a
											class="mr-3 text-sm font-medium uppercase text-primary-500 hover:text-primary-600 dark:hover:text-primary-400"
											href="/tags/next-js">next-js</a
										><a
								...
								<div class="prose max-w-none text-gray-500 dark:text-gray-400">
									...
									posts of similar content e.g. a multi-part course. This post is itself an example
									of a nested route!
								</div>
							</div>
							<div class="text-base font-medium leading-6">
						...
						<div class="space-y-5 xl:col-span-3">
							<div class="space-y-6">
								...
								<div class="prose max-w-none text-gray-500 dark:text-gray-400">
									...
									technology to support your blogging needs? Checkout the Tailwind Nextjs Starter
									Blog template.
								</div>
							</div>
							<div class="text-base font-medium leading-6">
								<a
									...
									href="/blog/introducing-tailwind-nextjs-starter-blog">Read more →</a
								>
							</div>
						</div>
					</div>
					...
					<div class="space-y-2 xl:grid xl:grid-cols-4 xl:items-baseline xl:space-y-0">
						...
						<div class="space-y-5 xl:col-span-3">
							<div class="space-y-6">
								<div>
									<h2 class="text-2xl font-bold leading-8 tracking-tight">
										<a class="text-gray-900 dark:text-gray-100" href="/blog/deriving-ols-estimator"
							...
							<div class="text-base font-medium leading-6">
								<a
									...
									href="/blog/deriving-ols-estimator">Read more →</a
								>
							</div>
						</div>
					</div>
			...
			<form class="flex flex-col sm:flex-row">
				<div>
					<label for="email-input"
						><span class="sr-only">Email address</span><input
							autocomplete="email"
